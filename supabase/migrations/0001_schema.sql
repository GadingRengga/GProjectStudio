-- ============================================================================
-- 0001_schema.sql — Core tables + updated_at triggers
-- Source of truth: docs/DATABASE.md (run in order: 0001 → 0002 → 0003)
-- Run in the Supabase SQL Editor (or `supabase db execute -f ...`).
-- ============================================================================
...
-- ============================================================
-- AUTO-UPDATE updated_at (trigger function once, attached to every
-- table that has updated_at — docs/DATABASE.md)
-- ============================================================
